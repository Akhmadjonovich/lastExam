...
const Footer = () => {
  return (
    <div className='footer pt-20  '>
        ...
        <button className='flex mx-auto border-transparent text-nunito bg-[#163A34] px-8 py-5 rounded-2xl text-3xl max-2xl:text-2xl max-2xl:px-7 max-2xl:py-3 max-lg:text-xl max-sm:text-lg max-sm:px-5 text-white font-nunito  hover:bg-white hover:text-[#163A34] hover:border-[#163A34] hover:scale-105 border-3 transition-all font-bold'>Browse recipes</button>
        </div>
        <div className='flex items-center justify-between container mx-auto  py-10 px-20 max-md:px-10 max-sm:px-5 '>
            <h3 className='text-3xl max-xl:text-2xl max-md:text-xl max-sm:text-lg'>Made with ❤️ and 🥑</h3>
            <div className='flex items-center gap-10 max-sm:gap-5 *:w-10 *:max-xl:w-10 *:max-md:w-7 *:max-sm:w-5'>
