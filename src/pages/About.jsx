  ...
  return (
    ...
    <section className='flex max-md:flex-col items-center justify-between container  gap-50 max-lg:gap-20 max-md:gap-10 max-sm:px-5 mt-20 max-md:mt-10'>
        <div>
          ...
          more often.</h2>
          <p className='text-3xl text-[#395852] max-2xl:text-2xl max-xl:text-lg '>Healthy Recipe Finder was created to prove that healthy eating can be convenient, affordable, and genuinely delicious.</p>
          <p className='text-3xl mt-10 max-lg:mt-5 text-[#395852] max-2xl:text-2xl max-xl:text-lg '>We showcase quick, whole-food dishes that anyone can master—no fancy equipment, no ultra-processed shortcuts—just honest ingredients and straightforward steps.</p>
        </div>
